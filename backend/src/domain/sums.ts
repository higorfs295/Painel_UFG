// Somas por composição com teto de exibição em 100% (RF-05) — portado de frontend/src/lib/sums.ts.
// Valores reais preservados; percentuais travados em 100% (a UI mostra "+Xh além do mínimo").
