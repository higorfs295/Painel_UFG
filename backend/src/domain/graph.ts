// Grafo de requisitos — portado de frontend/src/lib/graph.ts (mesma lógica, testada).
// Mantenha as duas cópias em sincronia; a fonte de verdade do cálculo é o servidor (RF-06/07).
export type Subject = {
